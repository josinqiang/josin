...
COMMENT ON TABLE dw.tf_fin_das_leading_group_manual_dxzx IS 'DAS班子会中心手工填报抵消表';

-- Column comments

COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.project IS '项目';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.production_line IS '产线';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.bu IS 'BU';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.years IS '年份';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.year_round IS '全年合计';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.january IS '1月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.february IS '2月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.march IS '3月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.april IS '4月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.may IS '5月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.june IS '6月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.july IS '7月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.august IS '8月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.september IS '9月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.october IS '10月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.november IS '11月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.december IS '12月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.next_january IS '下年1月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.next_february IS '下年2月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_dxzx.next_march IS '下年3月';
