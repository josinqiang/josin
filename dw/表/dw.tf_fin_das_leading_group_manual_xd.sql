...
COMMENT ON TABLE dw.tf_fin_das_leading_group_manual_xd IS 'DAS班子会现地手工填报表';

-- Column comments

COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.project IS '项目';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.production_line IS '产线';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.bu IS 'BU';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.years IS '年份';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.year_round IS '全年合计';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.january IS '1月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.february IS '2月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.march IS '3月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.april IS '4月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.may IS '5月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.june IS '6月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.july IS '7月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.august IS '8月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.september IS '9月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.october IS '10月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.november IS '11月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.december IS '12月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.next_january IS '下年1月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.next_february IS '下年2月';
COMMENT ON COLUMN dw.tf_fin_das_leading_group_manual_xd.next_march IS '下年3月';
