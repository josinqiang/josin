...
COMMENT ON TABLE dw.tf_fin_ibds_sales_production_line_mosbu_overview IS '财务指标-mosbu产线别总览';

-- Column comments

COMMENT ON COLUMN dw.tf_fin_ibds_sales_production_line_mosbu_overview.project IS '项目';
COMMENT ON COLUMN dw.tf_fin_ibds_sales_production_line_mosbu_overview.production_line IS '产线';
COMMENT ON COLUMN dw.tf_fin_ibds_sales_production_line_mosbu_overview.years IS '年份';
COMMENT ON COLUMN dw.tf_fin_ibds_sales_production_line_mosbu_overview.year_round IS '年度值';
COMMENT ON COLUMN dw.tf_fin_ibds_sales_production_line_mosbu_overview.month_wid IS '月份';
COMMENT ON COLUMN dw.tf_fin_ibds_sales_production_line_mosbu_overview.value IS '数值';
