...
-- DROP TABLE dw.tf_fin_mdm_costc_ch_base;

CREATE TABLE dw.tf_fin_mdm_costc_ch_base (
...
ALTER TABLE dw.tf_fin_mdm_costc_ch_base OWNER TO ur_uown_edw;
GRANT ALL ON TABLE dw.tf_fin_mdm_costc_ch_base TO ur_uown_edw;
GRANT ALL ON TABLE dw.tf_fin_mdm_costc_ch_base TO gr_uapp_data;
GRANT SELECT ON TABLE dw.tf_fin_mdm_costc_ch_base TO gr_uqry_data;
