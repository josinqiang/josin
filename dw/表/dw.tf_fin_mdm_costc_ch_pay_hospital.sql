...
-- DROP TABLE dw.tf_fin_mdm_costc_ch_pay_hospital;

CREATE TABLE dw.tf_fin_mdm_costc_ch_pay_hospital (
...
ALTER TABLE dw.tf_fin_mdm_costc_ch_pay_hospital OWNER TO ur_uown_edw;
GRANT ALL ON TABLE dw.tf_fin_mdm_costc_ch_pay_hospital TO ur_uown_edw;
GRANT ALL ON TABLE dw.tf_fin_mdm_costc_ch_pay_hospital TO gr_uapp_data;
GRANT SELECT ON TABLE dw.tf_fin_mdm_costc_ch_pay_hospital TO gr_uqry_data;
