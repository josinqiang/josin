...
-- DROP TABLE dw.tf_fin_mdm_costc_ch_pay_no_procedure;

CREATE TABLE dw.tf_fin_mdm_costc_ch_pay_no_procedure (
	row_wid int8 NULL,
...
ALTER TABLE dw.tf_fin_mdm_costc_ch_pay_no_procedure OWNER TO ur_uown_edw;
GRANT ALL ON TABLE dw.tf_fin_mdm_costc_ch_pay_no_procedure TO ur_uown_edw;
GRANT ALL ON TABLE dw.tf_fin_mdm_costc_ch_pay_no_procedure TO gr_uapp_data;
GRANT SELECT ON TABLE dw.tf_fin_mdm_costc_ch_pay_no_procedure TO gr_uqry_data;
