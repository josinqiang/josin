...
-- DROP TABLE dw.tf_pur_srm_vendor_month;

CREATE TABLE dw.tf_pur_srm_vendor_month (
...
ALTER TABLE dw.tf_pur_srm_vendor_month OWNER TO ur_uown_edw;
GRANT ALL ON TABLE dw.tf_pur_srm_vendor_month TO ur_uown_edw;
GRANT ALL ON TABLE dw.tf_pur_srm_vendor_month TO gr_uapp_data;
GRANT SELECT ON TABLE dw.tf_pur_srm_vendor_month TO gr_uqry_data;
