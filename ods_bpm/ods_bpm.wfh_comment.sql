...
-- DROP TABLE ods_bpm.wfh_comment;

CREATE TABLE ods_bpm.wfh_comment (
...
ALTER TABLE ods_bpm.wfh_comment OWNER TO ur_uown_ods;
GRANT ALL ON TABLE ods_bpm.wfh_comment TO ur_uown_ods;
GRANT SELECT ON TABLE ods_bpm.wfh_comment TO gr_uqry_data;
GRANT ALL ON TABLE ods_bpm.wfh_comment TO gr_uapp_data;
