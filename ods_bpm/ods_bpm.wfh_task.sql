...
-- DROP TABLE ods_bpm.wfh_task;

CREATE TABLE ods_bpm.wfh_task (
	...
	endenginenode varchar(270) NULL,
...
ALTER TABLE ods_bpm.wfh_task OWNER TO ur_uown_ods;
GRANT ALL ON TABLE ods_bpm.wfh_task TO ur_uown_ods;
GRANT SELECT ON TABLE ods_bpm.wfh_task TO gr_uqry_data;
GRANT ALL ON TABLE ods_bpm.wfh_task TO gr_uapp_data;
