...
-- DROP TABLE ods_machine.b4_cf_r2_d_process_history2;

CREATE TABLE ods_machine.b4_cf_r2_d_process_history2 (
...
COMMENT ON TABLE ods_machine.b4_cf_r2_d_process_history2 IS 'coater吐胶历史表2,data1~data32字段注释详见m_process_define表33行至64行数据';

-- Permissions

ALTER TABLE ods_machine.b4_cf_r2_d_process_history2 OWNER TO ur_uown_ods;
GRANT ALL ON TABLE ods_machine.b4_cf_r2_d_process_history2 TO ur_uown_ods;
GRANT ALL ON TABLE ods_machine.b4_cf_r2_d_process_history2 TO gr_uapp_data;
GRANT SELECT ON TABLE ods_machine.b4_cf_r2_d_process_history2 TO gr_uqry_data;
